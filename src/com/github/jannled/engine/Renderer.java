...
public class Renderer implements GLEventListener
{
	...
	public void init(GLAutoDrawable drawable) 
	{
		...
		shaderLoader.loadShaders("/com/github/jannled/engine/shaders/VertexShader.gls", "/com/github/jannled/engine/shaders/FragmentShader.gls");
		
		modelLoader.load(PreparedModels.triangle);
