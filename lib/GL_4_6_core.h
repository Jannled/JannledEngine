...
typedef void  (GL_APIENTRY *PFN_glPolygonOffsetClamp)(GLfloat factor, GLfloat units, GLfloat clamp);
extern PFN_glPolygonOffsetClamp _glptr_glPolygonOffsetClamp;
#define glPolygonOffsetClamp _glptr_glPolygonOffsetClamp

typedef void  (GL_APIENTRY *PFN_glMultiDrawArraysIndirectCount)(GLenum mode, const void * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
extern PFN_glMultiDrawArraysIndirectCount _glptr_glMultiDrawArraysIndirectCount;
#define glMultiDrawArraysIndirectCount _glptr_glMultiDrawArraysIndirectCount

typedef void  (GL_APIENTRY *PFN_glSpecializeShader)(GLuint shader, const GLchar * pEntryPoint, GLuint numSpecializationConstants, const GLuint * pConstantIndex, const GLuint * pConstantValue);
extern PFN_glSpecializeShader _glptr_glSpecializeShader;
#define glSpecializeShader _glptr_glSpecializeShader
...
typedef void  (GL_APIENTRY *PFN_glMultiDrawElementsIndirectCount)(GLenum mode, GLenum type, const void * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride);
extern PFN_glMultiDrawElementsIndirectCount _glptr_glMultiDrawElementsIndirectCount;
#define glMultiDrawElementsIndirectCount _glptr_glMultiDrawElementsIndirectCount
