#include "GL_4_6_core.h"
/* This file was auto-generated by Galogen */
/* OpenGL Version 4.6 Core, no extensions */
#include <assert.h>
#if defined(_WIN32)
...
static void  GL_APIENTRY _impl_glPolygonOffsetClamp (GLfloat factor, GLfloat units, GLfloat clamp) {
  _glptr_glPolygonOffsetClamp = (PFN_glPolygonOffsetClamp)GalogenGetProcAddress("glPolygonOffsetClamp");
   _glptr_glPolygonOffsetClamp(factor, units, clamp);
}
PFN_glPolygonOffsetClamp _glptr_glPolygonOffsetClamp = _impl_glPolygonOffsetClamp;

static void  GL_APIENTRY _impl_glMultiDrawArraysIndirectCount (GLenum mode, const void * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride) {
  _glptr_glMultiDrawArraysIndirectCount = (PFN_glMultiDrawArraysIndirectCount)GalogenGetProcAddress("glMultiDrawArraysIndirectCount");
   _glptr_glMultiDrawArraysIndirectCount(mode, indirect, drawcount, maxdrawcount, stride);
}
PFN_glMultiDrawArraysIndirectCount _glptr_glMultiDrawArraysIndirectCount = _impl_glMultiDrawArraysIndirectCount;

static void  GL_APIENTRY _impl_glSpecializeShader (GLuint shader, const GLchar * pEntryPoint, GLuint numSpecializationConstants, const GLuint * pConstantIndex, const GLuint * pConstantValue) {
  _glptr_glSpecializeShader = (PFN_glSpecializeShader)GalogenGetProcAddress("glSpecializeShader");
   _glptr_glSpecializeShader(shader, pEntryPoint, numSpecializationConstants, pConstantIndex, pConstantValue);
}
PFN_glSpecializeShader _glptr_glSpecializeShader = _impl_glSpecializeShader;
...
static void  GL_APIENTRY _impl_glMultiDrawElementsIndirectCount (GLenum mode, GLenum type, const void * indirect, GLintptr drawcount, GLsizei maxdrawcount, GLsizei stride) {
  _glptr_glMultiDrawElementsIndirectCount = (PFN_glMultiDrawElementsIndirectCount)GalogenGetProcAddress("glMultiDrawElementsIndirectCount");
   _glptr_glMultiDrawElementsIndirectCount(mode, type, indirect, drawcount, maxdrawcount, stride);
}
PFN_glMultiDrawElementsIndirectCount _glptr_glMultiDrawElementsIndirectCount = _impl_glMultiDrawElementsIndirectCount;
